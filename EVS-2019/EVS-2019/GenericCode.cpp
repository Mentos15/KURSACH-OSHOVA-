...
//				if (nump != 0)
//				{
//					if (idif.table[ll].iddatatype == IT::CHISL)
//						*out.stream << ": DWORD, ";
//					else if (idif.table[ll].iddatatype == IT::STOK)
//						*out.stream << ": SDWORD, "; //  ????????
//				}
//
//				else if (nump == 0)
...
//		{
//			if (idif.table[i].iddatatype == IT::STOK)
//			{
//				*out.stream << "\t" << idif.table[i].id << " SDWORD " << idif.table[i].value.vstr.str << ", 0" << "\n";
//			}
//			else if (idif.table[i].iddatatype == IT::CHISL)
//			{
//				if (idif.table[i].systema == IT::Ten)
//				{
//					*out.stream << "\t" << idif.table[i].id << " DWORD " << idif.table[i].value.vint.ten << '\n';
//				}
//				else if (idif.table[i].systema == IT::Vosmer)
//				{
//					*out.stream << "\t" << idif.table[i].id << " DWORD " << idif.table[i].value.vint.vosmer << "h\n";
//				}
//			}
//		}
//	}
...
//		{
//			if (idif.table[i].iddatatype == IT::CHISL)
//				*out.stream << "\tret_" << idif.table[i].id << " DWORD ?" << '\n';
//			else if (idif.table[i].iddatatype == IT::STOK)
...
//			if (idif.table[i].iddatatype == IT::STOK)
//			{
//				*out.stream << "\t" << idif.table[i].namefun << idif.table[i].id << " SDWORD ?\n";
//			}
//			else if (idif.table[i].iddatatype == IT::CHISL)
//			{
//				*out.stream << "\t" << idif.table[i].namefun << idif.table[i].id << " DWORD ?\n";
//			}
//		}
//	}
//	*out.stream << "\n.CODE\n\n";
...
//				*out.stream << idif.table[t.table[i].idxTI].namefun << " PROC ";
//				for (int j = 0; j < idif.size; j++)
//				{
//					if (idif.table[j].idtype == IT::P && (strcmp(idif.table[t.table[i].idxTI].id, idif.table[j].namefun) == 0))
//					{
//						nump--;
//						if (nump != 0)
//						{
//							if (idif.table[j].iddatatype == IT::CHISL)
//								*out.stream << idif.table[j].id << ": DWORD, ";
//							else if (idif.table[j].iddatatype == IT::STOK)
...
//								{
//									*out.stream << "\tpush " << idif.table[t.table[i].idxTI].namefun << idif.table[t.table[i].idxTI].id << "\n";
//								}
...
//										i++;
//									}
//									*out.stream << "\tcall " << idif.table[t.table[l].idxTI].namefun << "\n";
...
//							i++;
//						}
//						*out.stream << "\tpop " << idif.table[lex.idxTI].namefun << idif.table[lex.idxTI].id << "\n";
//					}
//					if (t.table[i].lexema[0] == 'c')
//					{
//						if (idif.table[t.table[i + 2].idxTI].systema == IT::Ten)
//							*out.stream << "\tmov ecx, " << idif.table[t.table[i + 2].idxTI].value.vint.ten << '\n';
//						else if (idif.table[t.table[i + 2].idxTI].systema == IT::Vosmer)
//							*out.stream << "\tmov ecx, " << idif.table[t.table[i + 2].idxTI].value.vint.vosmer << '\n';
//						while (t.table[i].lexema[0] != '}')
//						{
//							if (t.table[i - 1].lexema[0] == '=')
//							{
...
//							{
//								*out.stream << "\tpush " << idif.table[t.table[i + 1].idxTI].namefun << idif.table[t.table[i + 1].idxTI].id << '\n';
//								if (idif.table[t.table[i + 1].idxTI].iddatatype == IT::STOK)
//									*out.stream << "\tcall WriteInConsoleChar\n";
//								else if (idif.table[t.table[i + 1].idxTI].iddatatype == IT::CHISL)
...
//					{
//						*out.stream << "\tpush " << idif.table[t.table[i + 1].idxTI].namefun << idif.table[t.table[i + 1].idxTI].id << '\n';
//						*out.stream << "\tpop " << "ret_" << idif.table[t.table[i + 1].idxTI].namefun << '\n';
//					}
//					i++;
//				}
//				*out.stream << "ret\n";
